...
@section('title','Assessment Result Edit')
@section('content')
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="kt-portlet">
					...
					{{Form::model($assessmentResult,['route'=>['assessmentResult.update',$assessmentResult->id],'method'=>'PUT','id'=>'assessmentEdit','class'=>'kt-form'])}}
